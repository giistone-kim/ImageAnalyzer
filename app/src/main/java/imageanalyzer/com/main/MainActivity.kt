...
class MainActivity : AppCompatActivity() {
    ...
    private var labelDetectionTask: LabelDetectionTask? = null
     ...
     val FACE_DETECTION_REQUEST = "face_detection_request"
     val LOGO_DETECTION_REQUEST = "logo_detection_request"
        ...
        DetectionChooser().apply {
            ...
            .DetectionChooserNotifierInterface {
                ...
                override fun detectFace() {
                    findViewById<ImageView>(R.id.uploaded_image).setImageBitmap(bitmap)
                    requestCloudVisionApi(bitmap, FACE_DETECTION_REQUEST)
                }

                override fun detectLogo() {
                    findViewById<ImageView>(R.id.uploaded_image).setImageBitmap(bitmap)
                    requestCloudVisionApi(bitmap, LOGO_DETECTION_REQUEST)
                }
            })
